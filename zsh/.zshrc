# log system info in the terminal
pfetch
...
# misc
alias help="cat ~/.config/hypr/hyprland.conf | grep mainMod"
alias nuke="sudo rm -rfI" # not really a nuke if it asks for confirmation but i'd rather not fuck up big time
